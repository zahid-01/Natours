...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiemFoaWQwMSIsImEiOiJjbGFqYWtqcnYwYXkwM3ZycWVlNzNoeW56In0.LUy248glfYR3_vJgbNJhOA';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'Success') {
              (0, _alerts.showAlert)('error', 'Logged out successfuly');
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51M6nsQSDOobx5Z6rHgqPiLuidjpToZrZmAfdJOwiI27L2yy26DKRZXJ3hxmYcCpLoEzUfg3QK3ltWNCqb3Ll4lfk00drwlA3lS');
var bookTheTour = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/booking/get-checkout/".concat(tourId));
          case 3:
  ...
  return function bookTheTour(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.bookTheTour = bookTheTour;
...
if (updateSettings) {
  updateSettings.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSetting)(form, 'settings');
  });
}
if (updatePassword) {
  updatePassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var password, updatePassword, confirmPassword;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
...
if (bookTour) {
  bookTour.addEventListener('click', function (e) {
    var tourId = bookTour.dataset.tourid;
    (0, _stripe.bookTheTour)(tourId);
  });
}
